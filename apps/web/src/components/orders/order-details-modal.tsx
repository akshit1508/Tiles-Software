...
import { Phone, MapPin, XCircle, CreditCard, ShoppingCart } from 'lucide-react';
      ...
      <div className="space-y-5">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              ...
              {activeOrder.status === 'COMPLETED' && (
                <Button
                  ...
                  className="text-rose-700 border-rose-200 hover:bg-rose-50 self-start sm:self-auto"
                >
        ...
        {isLoading && !detail ? (
          ...
          <div className="space-y-4">
            ...
            {/* Recorded Payments (if any) */}
            {activeOrder?.payments && activeOrder.payments.length > 0 && (
              <div>
                <h4 className="text-xs font-semibold uppercase tracking-wider text-slate-700 mb-2 flex items-center gap-1.5">
                  <CreditCard className="h-3.5 w-3.5 text-slate-500" />
                  Recorded Payments ({activeOrder.payments.length})
                </h4>
                <div className="rounded-lg border border-slate-200 bg-white overflow-hidden">
                  <Table>
                    <TableHeader>
